...
export class NewsListComponent implements OnInit {
  ...
  private dataUrl = 'GetTDNewsListData';
  private enableUrl = 'EditTDNewsEnableData';
  private topUrl = 'EditTDNewsTopData';
  private delUrl = 'DelNewsData';

  tableTitle = ['#', '標題', '上架日期(起訖)', '建立時間', '建立者',
    '更新時間', '更新者', '置頂', '停用', '編輯'];
  data: NewsInfo[];
  rowTotal = 0;
  currentpage = 1;
