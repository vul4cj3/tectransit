...
import { FaqInfo, FaqCate } from 'src/app/_Helper/models';
...
export class FaqListComponent implements OnInit {
  ...
  private dataUrl = 'GetTDFaqListData';
  private catedataUrl = 'GetTDFaqCateData';
  private enableUrl = 'EditTDFaqEnableData';
  private topUrl = 'EditTDFaqTopData';
  private delUrl = 'DelFaqData';
  ...
  cateChange(val) {
    document.location.href = '/admin/faq/info/' + val;
  }
