...
@Component({
  selector: 'app-companyrank-edit',
  templateUrl: './companyrank-edit.component.html',
  styleUrls: ['./companyrank-edit.component.css']
})
export class CompanyrankEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataForm = this.formBuilder.group({
      ...
      ranktype: ['0', Validators.required],
      rankname: '',
      rankdesc: '',
      rankseq: '',
      isenable: '1',
