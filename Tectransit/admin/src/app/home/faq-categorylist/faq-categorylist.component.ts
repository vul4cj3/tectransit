...
@Component({
  selector: 'app-faq-categorylist',
  templateUrl: './faq-categorylist.component.html',
  styleUrls: ['./faq-categorylist.component.css']
})
export class FaqCategorylistComponent implements OnInit {

  /* Web api url*/
  private baseUrl = window.location.origin + '/api/WebSetHelp/';
  private dataUrl = 'GetTDFaqCateListData';
  private enableUrl = 'EditTDFaqCateEnableData';
  private topUrl = 'EditTDFaqCateTopData';
  private delUrl = 'DelFaqCateData';
